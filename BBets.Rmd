...
Based on the histogram it seems as thought Browlows owe would need to be to make the the class size with the 2:1 raito is 4.30. The zeor is centered in the histogram. This is confirmed by the Min which is at about the -170 range, meaning that Brownlow can either win or lose.
